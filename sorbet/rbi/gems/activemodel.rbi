...
class ActiveModel::Type::Date < ActiveModel::Type::Value
  ...
  include Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_198
end
module Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_198
...
class ActiveModel::Type::DateTime < ActiveModel::Type::Value
  ...
  include ActiveModel::Type::Helpers::Timezone
  include Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_199
end
module Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_199
  def assert_valid_value(value); end
  def cast(value); end
  def value_constructed_by_mass_assignment?(value); end
  def value_from_multiparameter_assignment(values_hash); end
...
class ActiveModel::Type::Time < ActiveModel::Type::Value
  ...
  include ActiveModel::Type::Helpers::TimeValue
  include ActiveModel::Type::Helpers::Timezone
  include Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_200
end
module Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_200
  def assert_valid_value(value); end
  def cast(value); end
  def value_constructed_by_mass_assignment?(value); end
  def value_from_multiparameter_assignment(values_hash); end
