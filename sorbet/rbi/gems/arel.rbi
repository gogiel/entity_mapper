...
class Arel::Attributes::Attribute < Anonymous_Struct_201
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_202
end
...
class Arel::SelectManager::Row < Anonymous_Struct_203
  def id; end
